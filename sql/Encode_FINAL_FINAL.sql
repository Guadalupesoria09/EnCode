...
(11, 'PROMO TRY', '2024-10-12 06:00:00', '2024-10-17 06:00:00', 1, 500, 0, 1, NULL),
(12, 'Promo 123', '2024-10-18 06:00:00', '2024-10-19 06:00:00', 1, 0, 0, 1, NULL),
(13, '123', '2024-10-17 06:00:00', '2024-10-19 06:00:00', 12, 123, 0, 1, NULL),
(14, 'last try', '2024-10-18 06:00:00', '2024-10-19 06:00:00', 1, 0, 0, 1, NULL),
(15, 'last try hopefully', '2024-10-26 06:00:00', '2024-10-31 06:00:00', 2, 100, 0, 1, NULL);
...
CREATE TABLE `tarjeta` (
  `IDTarjeta` int(11) NOT NULL,
  `IDUsuario` int(11) NOT NULL,
  `SellosTotal` int(11) DEFAULT 0,
  `SellosActual` int(11) DEFAULT NULL,
...
INSERT INTO `tarjeta` (`IDTarjeta`, `IDUsuario`, `SellosTotal`, `SellosActual`, `Limite`, `Actual`, `IDSucursal`) VALUES
(1, 7, 17, 37, 10, 1, 1),
(2, 8, 13, 13, 10, 1, 1),
(3, 9, 5, 5, 10, 1, 1),
(4, 10, 10, 10, 10, 1, 1),
...
(85, 'Daniel', '5555', '2024-10-21', '$2a$12$2bmjkeFQxSGaVEIq8skXsOnzJPUXWkVL6evv1RblwRa2X95Hq5q1W', 'Masculino', 'lol', 'qro', 'Baja California Sur', NULL),
(87, 'Ernesto', '3211', '2024-10-16', '$2a$12$5Q4f8I0JJkl4W.B0TCqEae1jv8MyEmDJRbLEv87l82RMBbvy3bevi', 'Masculino', 'lol', 'Torreon', 'Baja California Sur', NULL);
...
CREATE TABLE `vista` (
  ...
  `nombreTarjeta` varchar(250) DEFAULT NULL,
...
INSERT INTO `vista` (`IDVista`, `nombreTarjeta`, `Logo`, `Color`, `Font`, `IDSucursal`) VALUES
(1, 'DUPER REWARDS', '1728925782806Dupper-brands-logo.png', '#2141de', 'Times New Roman', 1),
(3, 'CAFELE REWARDS', '1728927656718coffeeShop.png', '#4d0000', 'Arial', 1),
(4, 'Chilaquiles', '1728928537569chilaquilesRojos.png', '#4b3f3f', 'Cambria', 1),
(5, 'Times New Roman', 'PRueba', '1728931802822TRYBUENA.png', '#e9e2c4', 1),
(6, 'PIZZERIA REWARDS', '1728931907798TRYBUENA.png', '#f0e4c1', 'Times New Roman', 1),
(7, 'Los Pambazitos', '1728932016233pambazoMigue.png', '#ce2727', 'Georgia', 1);
...
--
-- Indexes for table `vista`
--
ALTER TABLE `vista`
  ADD PRIMARY KEY (`IDVista`),
  ADD KEY `fk_sucursalCarcasa` (`IDSucursal`);
...
--
ALTER TABLE `promocion`
  MODIFY `IDPromocion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `promocionsucursalrecompensa`
--
ALTER TABLE `promocionsucursalrecompensa`
  MODIFY `IDPromocionSucurRecompensa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `usuario`
  MODIFY `IDUsuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
...
--
ALTER TABLE `usuariosucursal`
  MODIFY `IDUsuarioSucursal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
-- Constraints for table `vista`
--
ALTER TABLE `vista`
  ADD CONSTRAINT `fk_sucursalCarcasa` FOREIGN KEY (`IDSucursal`) REFERENCES `sucursal` (`IDSucursal`);
COMMIT;
